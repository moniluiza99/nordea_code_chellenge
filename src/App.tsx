...
const App:FC<{}> = ()=>{
    ...
    return(
        <div>
            <input
                type="number"
                onChange={(e:ChangeEvent<HTMLInputElement>)=>{setValueA(parseInt(e.target.value))}}
                value={valueA}
                min={MIN_VALUE}
            />
            <input
                type="number"
                onChange={(e:ChangeEvent<HTMLInputElement>)=>{setValueB(parseInt(e.target.value))}}
                value={valueB}
                min={MIN_VALUE}
            />
            <input
                type="number"
                onChange={(e:ChangeEvent<HTMLInputElement>)=>{setValueC(parseInt(e.target.value))}}
                value={valueC}
                min={MIN_VALUE}
            />
